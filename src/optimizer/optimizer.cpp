  ...
  switch (stmt_type) {
    case StatementType::DROP: {
      ...
      unique_ptr<planner::AbstractPlan> drop_plan(
          new planner::DropPlan(std::dynamic_pointer_cast<parser::DropStatement>(tree), txn));
    ...
    case StatementType::ANALYZE: {
      ...
      unique_ptr<planner::AbstractPlan> analyze_plan(
          new planner::AnalyzePlan(std::dynamic_pointer_cast<parser::AnalyzeStatement>(tree), txn));
